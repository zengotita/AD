...
public class CrearEmpleadoXml_DOM {
    public static void main(String argv[]) throws IOException{
        ...
        try{
            ...
            Document document = implementation.createDocument(null, "EmpleadosDOM", null);
            ...
            for(;;) {
                ...
                posicion= posicion + 36; // me posiciono para el sig empleado del for que recorre el fichero
                if (file.getFilePointer() == file.length())   break;

            }

            Source source = new DOMSource(document);
            Result result = new StreamResult(new java.io.File(".//ficheros//EmpleadosDOM.xml"));
    ...
    static void  CrearElemento(String datoEmple, String valor, Element raiz, Document document){
        ...
        elem.appendChild(text); //pegamos el valor de la clase
    }
}
